...
3. Install required libraries (listed in code comments)
4. Upload to your ESP32/Arduino
5. Follow the circuit diagram below
...
## 📋 Parts Lists (NPR Pricing)

### Video 1: Auto Irrigation
| Component | Cost (NPR) | Supplier |
|-----------|----------|----------|
| ESP32 | 500 |
| FC-28 Soil Moisture | 150 | Local electronics shop |
| 5V Relay | 100 | Kathmandu Electronics |
| Water Pump | 300 | Hardware store |
| Breadboard + Wires | 50 | Any electronics shop |
